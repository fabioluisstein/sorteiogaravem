...
vagas_estendidas=35,36

# Exemplo: Para tornar as vagas 7, 14 e 21 estendidas:
# vagas_estendidas=7,14,21
```
...
### 4. **Apartamentos com Direito a Vagas Estendidas**
```properties
# Apartamentos que podem participar do sorteio das vagas estendidas
apartamentos_vagas_estendidas=101,103,105,201,203

# Exemplo: Para permitir que o apartamento 401 concorra:
# apartamentos_vagas_estendidas=101,103,105,201,203,401
```

## 📋 Exemplos de Configuração

### Cenário 1: Vagas 7 e 14 são estendidas
```properties
vagas_estendidas=7,14
apartamentos_vagas_estendidas=101,201,301
```

### Cenário 2: Apenas vaga 42 é estendida
```properties
vagas_estendidas=42
apartamentos_vagas_estendidas=404,504
```

### Cenário 3: Sem vagas estendidas
```properties
vagas_estendidas=
...
### ✅ **Formato Correto:**
- **Números:** `vagas_estendidas=35,36,42`
- **Sem espaços extras:** `apartamentos_vagas_duplas=101,102,103`
- **Comentários com #:** `# Este é um comentário`

### ❌ **Evite:**
- **Espaços:** `vagas_estendidas= 35, 36 , 42`
- **Vírgula no final:** `vagas_estendidas=35,36,`
- **Números inválidos:** `vagas_estendidas=0,50,100`
...
2. **Vagas estendidas** são sempre individuais (não podem ser duplas)
3. **Numeração** deve ser sequencial e sem repetições
4. **Se sobrar vaga estendida**, ela entra no sorteio normal no final
